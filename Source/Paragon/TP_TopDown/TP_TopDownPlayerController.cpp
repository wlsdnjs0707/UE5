...
void ATP_TopDownPlayerController::SetupInputComponent()
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(InputComponent))
	{
		...
		EnhancedInputComponent->BindAction(LeftMouseClickAction, ETriggerEvent::Triggered, this, &ATP_TopDownPlayerController::LeftMouseClickTriggered);
...
void ATP_TopDownPlayerController::LeftMouseClickTriggered()
{
	StopMovement();
	...
	if (ControlledPawn != nullptr)
	{
		...
		ControlledPawn->SetActorRotation(WorldDirection.Rotation());
	}
}
